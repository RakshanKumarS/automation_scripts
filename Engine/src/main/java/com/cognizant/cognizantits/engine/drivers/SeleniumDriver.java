...
public class SeleniumDriver {
  ...
  static boolean RobotScreenShot = false;
    
    public static void setRoboSsPref(boolean isNeeded){
		RobotScreenShot = isNeeded;
	}
	public static boolean getRoboSsPref(){
		return RobotScreenShot;
	}
